<%@ Page Title="" Language="C#" MasterPageFile="~/backend/master/backend.master" AutoEventWireup="true" CodeFile="listele.aspx.cs" Inherits="backend_isler_listele" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="page_title" Runat="Server">
    <h1>İş <small> Listeleme işlemi</small></h1>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
        ...
        <div class="portlet-body">
            <table class="table table-striped table-hover" id="sample_5">
                ...
                <tbody>
                    <asp:Repeater ID="rpt_isler" runat="server" ItemType="Entity.isler">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="float: right;">
                                    <div class="btn-group btn-group-circle btn-group-solid btn-group-xs">
                                        ...
                                        <a class="btn green-seagreen" href="guncelle.aspx?id=<%#Item.id %>&isturu=<%#Item.is_turu %>&user=<%#Item.kullanici_id %>"" title="Update">
