<%@ Page Title="" Language="C#" MasterPageFile="~/backend/master/backend.master" AutoEventWireup="true" CodeFile="listele.aspx.cs" Inherits="backend_sosyal_tesis_listele" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
        ...
        <div class="portlet-body">
            <table class="table table-striped table-hover" id="sample_5">
                ...
                <tbody>
                    <asp:Repeater ID="rpt_sosyal_tesis" runat="server" ItemType="Entity.sosyal_tesis">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="float: right;">
                                    <div class="btn-group btn-group-circle btn-group-solid btn-group-xs">
                                        ...
                                        <a class="btn green-seagreen" href="guncelle.aspx?id=<%#Item.id%>" title="Update">
