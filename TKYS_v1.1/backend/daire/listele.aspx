<%@ Page Title="" Language="C#" MasterPageFile="~/backend/master/backend.master" AutoEventWireup="true" CodeFile="listele.aspx.cs" Inherits="backend_daire_listele" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
        ...
        <div class="portlet-body">
            <table class="table table-striped table-hover" id="sample_5">
                ...
                <tbody>
                    <asp:Repeater ID="rpt_daire" runat="server" ItemType="Entity.daire">
                        <ItemTemplate>
                            <tr>
