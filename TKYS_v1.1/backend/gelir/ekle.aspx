<%@ Page Title="" Language="C#" MasterPageFile="~/backend/master/backend.master" AutoEventWireup="true" CodeFile="ekle.aspx.cs" Inherits="backend_gelir_ekle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="page_title" Runat="Server">
    <h1>Gelir <small> Ekleme işlemi</small></h1>
</asp:Content>
    ...
    <div class="portlet light">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-green-sharp bold uppercase">Gelir Formu</span>
            </div>
            <div class="tools">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <asp:RequiredFieldValidator class="help-block" ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_miktar" ErrorMessage="Miktar bölümü doldurulmalıdır.">Bu bölüm doldurulmalıdır.</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
