                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_miktar" ErrorMessage="Miktar bölümü doldurulmalıdır.">Miktar bölümü doldurulmalıdır.</asp:RequiredFieldValidator>
                                <div class="col-md-8">
                                    <asp:TextBox ID="txt_miktar" runat="server" class="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
