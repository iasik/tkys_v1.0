            ...
            <form id="form" runat="server" class="form-horizontal">
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-md-2">Miktar:</label><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_miktar" ErrorMessage="Miktar bölümü doldurulmalıdır.">Miktar bölümü doldurulmalıdır.</asp:RequiredFieldValidator>
&nbsp;<div class="col-md-8">
