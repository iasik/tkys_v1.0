                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="DropDownList1" ErrorMessage="Kullanıcı ID kısmı seçilmelidir.">Kullanıcı ID kısmı seçilmelidir.</asp:RequiredFieldValidator>
                                <div class="col-md-8">
