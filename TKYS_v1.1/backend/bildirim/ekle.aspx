...
<asp:Content ID="Content3" ContentPlaceHolderID="page_title" Runat="Server">
    <h1>Bildirim <small> Ekleme işlemi</small></h1>
</asp:Content>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <asp:RequiredFieldValidator CssClass="help-block" ID="RequiredFieldValidator8" runat="server" ControlToValidate="DropDownList1" ErrorMessage="Kullanıcı ID kısmı seçilmelidir.">Kullanıcı ID kısmı seçilmelidir.</asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-9">
                                        <asp:Button ID="btn_ekle" runat="server" Text="Ekle" OnClick="btn_ekle_Click" class="btn btn-green" />
                                    </div>
                                </div>
                            </div>
                        </div>
