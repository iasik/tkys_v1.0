<%@ Page Title="" Language="C#" MasterPageFile="~/frontend/master/front.master" AutoEventWireup="true" CodeFile="ekle.aspx.cs" Inherits="frontend_etkinlik_ekle" %>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-9">
                                        <asp:Button ID="btn_ekle" runat="server" Text="Ekle" class="btn green" OnClick="btn_ekle_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
